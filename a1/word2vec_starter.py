...
def word2vec(batch_gen):
    ...
    nce_loss = tf.reduce_mean(tf.nn.nce_loss(nce_weight, nce_bias, target_words, embed, NUM_SAMPLED, VOCAB_SIZE), name='loss')
    ...
    with tf.Session() as sess:
        ...
        for index in range(NUM_TRAIN_STEPS):
            ...
            _, loss_batch = sess.run([optimizer, nce_loss], feed_dict={center_words: centers, target_words: targets})
